    ...
    <div class="bg-[#F3F3F3] rounded-2xl">
        ...
        <div class="bg-white rounded-2xl p-4 sm:p-6 shadow-sm max-w-3xl mx-auto">
            ...
            <div class="flex items-center gap-3 mb-6">
                <a href="{{ route('laundry-transactions.create') }}" class="text-[18px] text-gray-500 hover:text-black">
                    ←
                </a>
            ...
            <div class="bg-[#FAFAFA] rounded-2xl p-4 mb-6">
                ...
                <form action="{{ route('laundry-transactions.step2.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.1" name="laundry_weight" placeholder="Kg"
                            class="w-full mt-1 rounded-xl border-gray-200
                                  px-4 py-3 text-sm
                                  focus:outline-none focus:ring-1 focus:ring-[#EA821B]">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="perfume" name="perfume"
                            class="w-full mt-1 rounded-xl border-gray-200
                               px-4 py-3 text-sm
                               focus:outline-none focus:ring-1 focus:ring-[#EA821B]">>
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="3" placeholder="Silahkan tinggalkan catatan"
                            class="w-full mt-1 rounded-xl border-gray-200
                               px-4 py-3 text-sm
                               resize-none
