...
@section('content')
    <div class="bg-[#F3F3F3] rounded-2xl">
        ...
        <div class="bg-white rounded-2xl p-4 sm:p-6 shadow-sm flex flex-col lg:h-full lg:overflow-hidden">
                        ...
                        <table class="w-full table-fixed border-collapse">
                            <thead class="h-[56px]">
                                <tr class="border-b border-gray-300">
                                    ...
                                    <th class="text-right text-[15px] font-semibold">Jumlah Biaya</th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr class="h-[50px] border-b border-gray-200 last:border-none">
                                        ...
                                        <td class="text-right text-[15px]">
                                            ...
                                            <span class="text-gray-400">
                                                {{ number_format($overhead->cost_amount, 0, ',', '.') }}
                                            </span>
                                        </td>
                                    </tr>
                                @endforeach
                            ...
                            <div class="border border-gray-200 rounded-xl p-3 text-sm">
                                ...
                                <div class="flex justify-between items-center mt-2">
                                    ...
                                    <span class="font-medium text-[14px]">
                                        Rp {{ number_format($overhead->cost_amount, 0, ',', '.') }}
                                    </span>
                                </div>
                            </div>
                        @endforeach
            ...
            @include('partials.table-pagination', ['items' => $overheads])
